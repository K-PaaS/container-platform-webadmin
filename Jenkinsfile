	...
	stages {
		...
		stage('sed') {
		    steps {
		        ...
		        sh 'sed -i "s/file:\\/\\/\\/D:\\/_Work\\/PaaS-TA\\/svn\\/container\\/admin/memeber/login.html/http:\\/\\/\'+window.location.host.substr(0,window.location.host.indexOf(\':\',0)+1)+\'32080/g" WebContent/resources/js/common.js'
		        sh 'head -5 WebContent/resources/js/common.js'
		   }
		}
		stage('Environment') {
